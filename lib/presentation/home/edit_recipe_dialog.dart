...
class _EditRecipeDialogState extends ConsumerState<EditRecipeDialog> {
  ...
  void initState() {
    ...
    _proteinController = TextEditingController(
      text: widget.recipe.nutrition.protein.toString(),
    );
    _carbsController = TextEditingController(
      text: widget.recipe.nutrition.carbs.toString(),
    );
    _fatsController = TextEditingController(
      text: widget.recipe.nutrition.fats.toString(),
    );
    _fiberController = TextEditingController(
      text: widget.recipe.nutrition.fiber.toString(),
    );
    _sugarController = TextEditingController(
      text: widget.recipe.nutrition.sugar.toString(),
    );
  ...
  Future<void> _saveRecipe() async {
    ...
    try {
      ...
      await ref.read(recipeActionsProvider).updateRecipe(updatedRecipe);
...
class _IngredientDialog extends StatefulWidget {
  ...
  const _IngredientDialog({required this.onAdd, this.ingredient});
    ...
    return AlertDialog(
      title: Text(
        widget.instruction == null
            ? 'Add Instruction Step ${widget.stepNumber}'
            : 'Edit Instruction Step ${widget.stepNumber}',
      ),
      content: Form(
        key: _formKey,
        child: TextFormField(
